    ...
    <div className="bg-gray-100 text-gray-800 min-h-screen flex flex-col">
      <AuthProvider>
        ...
        <a
          ...
          className="fixed bottom-28 right-6 z-50 flex items-center justify-center w-16 h-16 bg-green-500 hover:bg-green-600 text-white rounded-full shadow-lg transition hover:scale-105"
